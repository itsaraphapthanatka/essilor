            ...
            <div class="container">
                ...
                <div class="card card-custom">
                    <div class="card-body">
                        ...
                        <div id="event_result">ddd</div>
                        <!-- <input type="hidden" id="userid" value="<?=$seq4;?>"> -->
                        <!-- <input type="text" id="show" name="vehicle"><br> -->
                        <!--end: Datatable-->
                    </div>
                </div>
                <link rel="stylesheet" href="<?php echo base_url()?>theme/dist/assets/plugins/custom/jstree/jstree.bundle.css" />
                <script src="<?php echo base_url()?>theme/dist/assets/plugins/custom/jstree/jstree.bundle.js"></script>
                <script>
                    ...
                    'core': {
                        ...
                        'data' : {
                            'url' : function (node) {
                            return node.id === '#' ?
                                '<?php echo base_url()?>jsondata/getModule_permisstion' :
                                '<?php echo base_url()?>jsondata/getModule_permisstion_detail';
                            },
                            'data' : function (node) {
                            return { 'id' : node.id };
                            }
