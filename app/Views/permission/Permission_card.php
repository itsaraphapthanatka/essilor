        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="#" class="btn btn-sm fw-bold btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_role">Create</a>
                    <!--end::Primary button-->
                </div>
                <!--end::Actions-->
            </div>
...
<script src="<?php echo base_url();?>theme/dist/assets/js/custom/apps/user-management/roles/list/add.js"></script>
<script src="<?php echo base_url();?>theme/dist/assets/js/custom/apps/user-management/roles/list/update-role.js"></script>
