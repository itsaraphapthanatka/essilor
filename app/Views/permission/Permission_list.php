		...
		<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
			...
			<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
				...
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					...
					<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Setup Role List</h1>
					<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
						...
						<!--begin::Item-->
						<li class="breadcrumb-item text-muted">
							<a href="/setupPermission/<?=$seq1;?>/<?=$seq2;?>/<?=$seq3;?>" class="text-muted text-hover-primary">Role List</a>
						</li>
						<!--end::Item-->
					</ul>
					<!--end::Title-->
							...
							<table id="kt_datatable_horizontal_scroll" class="table align-middle table-row-dashed fs-6 gy-5">
								<thead>
									<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
										<th class="min-w-80px">Role Group Code</th>
										<th class="min-w-125px">Role Group Name</th>
...
<script>
	...
	var KTDatatablesServerSide = function() {
		...
		var channalid = '10';
		var userlist = "jsondata/getGroupRole";
		var type_status = {
			0: {
				"title": "งานใหม่",
				"state": "primary"
						...
						render: function(data, type, row) {
							...
							<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-200px py-4" data-kt-menu="true">
								...
								<div class="menu-item px-3">
									<a href="/EmployeeEdit/${row.m_id}" class="menu-link px-3" data-kt-docs-table-filter="edit_row">
										Project Role
									</a>
								</div>
								<!--end::Menu item-->
