					...
					<div class="card-header pt-8">
						...
						<div class="card-toolbar">
							...
							<div class="d-flex justify-content-end" data-kt-filemanager-table-toolbar="base">
								<!--begin::Add customer-->
								<a href="/addMaterial/<?=$seq1;?>/<?=$seq2;?>/<?=$seq3;?>" type="button" class="btn btn-flex btn-primary">
								<i class="ki-duotone ki-folder-up fs-2">
									<span class="path1"></span>
									<span class="path2"></span>
								</i>Add Material Type</a>
								<!--end::Add customer-->
							</div>
							<!--end::Toolbar-->
						</div>
...
<script>
	...
	var KTDatatablesServerSide = function () {
		...
		var channalid = '10';
		var userlist = "jsondata/getmaterialType";
		var type_status = {
				...
				columnDefs: [
					...
					},
                    {
						...
						render: function(data, type, row) {
							return `<a href="/setupMaterialgroup/<?=$seq1;?>/<?=$seq2;?>/<?=$seq3;?>/${row.mattype_code}">${row.mattype_name}</a>`;
						}
					},
                    {
                        targets: 2, //สถานะ
						...
						render: function (data, type, row) {
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-200px py-4" data-kt-menu="true">									
									<div class="menu-item px-3">
										<a href="/editMaterial/<?=$seq1;?>/<?=$seq2;?>/<?=$seq3;?>/${row.mattype_id}" class="menu-link px-3" data-kt-docs-table-filter="edit_row">
											Edit
										</a>
									</div>
									<!--end::Menu item-->
