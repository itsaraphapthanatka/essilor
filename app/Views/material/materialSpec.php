		...
		<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
			...
			<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
				...
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					<!--begin::Title-->
					<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Setup Material Spec</h1>
					<!--end::Title-->
					<!--begin::Breadcrumb-->
					<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
						...
						<!--end::Item-->
						<!--begin::Item-->
						<li class="breadcrumb-item text-muted">Setup Material Spec</li>
						<!--end::Item-->
					</ul>
					<!--end::Breadcrumb-->
				</div>
					...
					<div class="card-body">
						...
						<div class="d-flex flex-stack">
							...
							<div class="badge badge-lg badge-light-success">
                                ...
                                <?=$type['mattype_code']?><?=$group['matgroup_code'];?><?=$subgroup['matsubgroup_code'];?><?=$product['matcode'];?>
							</div>
							</div>
							<!--end::Folder path-->
						</div>
...
<script>
	...
	var KTDatatablesServerSide = function () {
		...
		var userlist = "jsondata/getmaterialSpec/"+mat_type+"/"+mat_group+"/"+mat_subgroup+"/"+mat_product;
		var type_status = {
				...
				columnDefs: [
					...
					},
                    {
						...
						render: function(data, type, row) {
							return `<a href="/setupMaterialBrand/<?=$seq1;?>/<?=$seq2;?>/<?=$seq3;?>/${row.mattype_code}/${row.matgroup_code}/${row.matsubgroup_code}/${row.matcode}/${row.matspec_code}">${row.matspec_name}</a>`;
						}
					},
                    {
                        targets: 2, //สถานะ
