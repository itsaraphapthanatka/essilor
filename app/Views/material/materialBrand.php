		...
		<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
			...
			<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
				...
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					<!--begin::Title-->
					<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Setup Material Brand</h1>
					<!--end::Title-->
					<!--begin::Breadcrumb-->
					<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
						...
						<!--end::Item-->
						<!--begin::Item-->
						<li class="breadcrumb-item text-muted">Setup Material Brand</li>
						<!--end::Item-->
					</ul>
					<!--end::Breadcrumb-->
				</div>
					...
					<div class="card-header pt-8">
						<div class="card-title">
							...
							<div class="d-flex align-items-center position-relative my-1">
								...
								<input type="text" data-kt-filemanager-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Material Spec" />
							</div>
							<!--end::Search-->
						</div>
						<!--begin::Card toolbar-->
					...
					<div class="card-body">
						...
						<div class="d-flex flex-stack">
							...
							<div class="badge badge-lg badge-light-primary">
								...
								<i class="ki-duotone ki-right fs-2 text-primary mx-1"></i>
								<a href="/setupMaterialProduct/<?=$seq1;?>/<?=$seq2;?>/<?=$seq3;?>/<?=$mat_type;?>/<?=$mat_group;?>/<?=$mat_subgroup;?>/<?=$mat_product;?>">[<?=$product['matcode'];?>] <?=$product['matname'];?></a>
								<i class="ki-duotone ki-right fs-2 text-primary mx-1"></i>
								<a href="/setupMaterialSpec/<?=$seq1;?>/<?=$seq2;?>/<?=$seq3;?>/<?=$mat_type;?>/<?=$mat_group;?>/<?=$mat_subgroup;?>/<?=$mat_product;?>/<?=$mat_spec;?>">[<?=$spec['matspec_code'];?>] <?=$spec['matspec_name'];?></a>
							</div>
							</div>
							<!--end::Folder path-->
						</div>
						...
						<div class="d-flex flex-stack">
							...
							<div class="badge badge-lg badge-light-success">
                                ...
                                <div id="matcode"><?=$type['mattype_code']?><?=$group['matgroup_code'];?><?=$subgroup['matsubgroup_code'];?><?=$product['matcode'];?><?=$spec['matspec_code'];?></div>
							</div>
							</div>
							<!--end::Folder path-->
						</div>
...
<script>
	...
	var KTDatatablesServerSide = function () {
        ...
        var mat_product = "<?=$mat_product?>";
        var mat_spec = "<?=$mat_spec;?>";
        console.log(mat_type);
        console.log(mat_group);
        console.log(mat_subgroup);
        console.log(mat_spec);
		var userlist = "jsondata/getmaterialBrand/"+mat_type+"/"+mat_group+"/"+mat_subgroup+"/"+mat_product+"/"+mat_spec;
		var type_status = {
				...
				columnDefs: [
					...
					},
                    {
						...
						render: function(data, type, row) {
							return `<a href="#" data-kt-docs-table="click_row">${row.matbrand_name}</a>`;
						}
					},
                    {
                        targets: 2, //สถานะ
        ...
        var handleClickRows = () => {
            ...
            clickRows.forEach(d => {
                d.addEventListener('click', function (e) {
                    ...
                    document.getElementById('matcode').innerHTML = "<?=$type['mattype_code'];?><?=$group['matgroup_code'];?><?=$subgroup['matsubgroup_code'];?><?=$product['matcode'];?><?=$spec['matspec_code'];?>"+id;
                })
            });
        }
