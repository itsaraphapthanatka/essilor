                                        ...
                                        <div class="card-body pt-0">
                                            <div class="d-flex flex-wrap gap-5">
                                                ...
                                                <div class="mb-10 fv-row w-100 flex-md-root">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="text" readonly name="mat_type_code" class="form-control mb-2" placeholder="Meterial Type code" value="<?=$type['mattype_code'];?>" />
                                                    <input type="hidden" readonly name="mat_type_id" class="form-control mb-2" placeholder="Meterial Type code" value="<?=$type['mattype_id'];?>" />
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                            </div>
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" name="mat_type_name" class="form-control mb-2" placeholder="Meterial Type  Name" value="<?=$type['mattype_name'];?>" />
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
