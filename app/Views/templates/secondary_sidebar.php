...
<div class="app-sidebar-secondary">
    ...
    <div id="kt_app_sidebar_secondary_wrapper" class="hover-scroll-y" data-kt-scroll="true" data-kt-scroll-activate="{default: true, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependecies="#kt_app_header" data-kt-scroll-wrappers="#kt_app_content" data-kt-scroll-offset="5px">
        ...
        <div class="tab-content px-5 px-lg-10">
            <!--begin::Tab pane-->
            <div class="tab-pane fade" id="kt_app_sidebar_secondary_dahsboard" role="tabpanel">
                <div class="card card-reset card-p-0 load_dashboard">
                    <!--begin::Menu-->
                        ...
                        <div id="kt_aside_menu_wrapper" class="menu-fit">
                            ...
                            <div class="menu-item pt-5">
                                ...
                                <div class="menu-content">
                                    <span class="menu-heading fw-bold text-uppercase fs-7">แผงควบคุมทั้งหมด</span>
                                </div>
                                <!--end:Menu content-->
                            </div>
                            <!--end:Menu item-->
                            <div class="menu-item">
                                <a class="menu-link" href="/dashboard">
                                    ...
                                    <span class="menu-title">สรุปรายงานการจอง</span>
                                </a>
                            </div>
                            <!--begin:Menu item-->
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="/leave">
                                    <span class="menu-icon">
                                    ...
                                    <span class="menu-title">รายงานการไม่ว่าง</span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                            <!--end:Menu item-->
                        ...
                        <div id="kt_aside_menu_wrapper" class="menu-fit">
                            ...
                            <div class="menu-item">
                                ...
                                <a class="menu-link" href="/calendar">
                                    ...
                                    <span class="menu-title">ตั้งค่าผู้ดูแลห้อง</span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                            <!--end:Menu item-->
