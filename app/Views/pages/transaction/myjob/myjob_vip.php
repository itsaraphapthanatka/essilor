    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
        ...
        <div class="page-title d-flex flex-column align-items-start me-3 py-2 py-lg-0 gap-2">
            ...
            <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-gray-600">My job VIP</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
...
<script>
	...
	var KTDatatablesServerSide = function () {
		...
		var filterPayment;
		var channalid = '10';
		var userlist = "jsondata/getJobtaskCalljob/2"; // seq3 0= null , 1 = standard , 2 vip
		// Private functions
			...
			dt = $("#kt_datatable_horizontal_scroll").DataTable({
				...
				columnDefs: [
										...
										if (trackingPattern.test(trimmedID)) {
											if(trimmedID.length === 12){
												$.ajax({
													...
													success: function(response) {
														console.log(response);
														window.location.href = "<?= base_url('myjobvip') ?>"; // Ensure the URL is correct
													},
													error: function(xhr, status, error) {
														console.error('AJAX error:', status, error);
					...
					},
					{
						...
						render: function (data, type, row) {
                            return `
								<a href="<?php echo base_url();?>returnjob/${data.id}/myjobvip" class="btn btn-light-danger btn-sm">
									Return Job
								</a>
							`;
						},
		...
		var hadleCallJob = () => {
			...
			calljobButton.addEventListener('click', function (e) {
				...
				$.ajax({
					url: '<?php echo base_url(); ?>jsondata/getJobtaskUpdateCalljob/2',
					type: 'GET',
...
<script>
	 ...
	 $("#myjobvip").addClass('btn-light-primary');
