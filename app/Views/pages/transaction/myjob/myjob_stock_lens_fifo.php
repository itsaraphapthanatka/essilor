    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
        ...
        <div class="page-title d-flex flex-column align-items-start me-3 py-2 py-lg-0 gap-2">
            ...
            <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-gray-600">My Job Stock Lens</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
...
<script>
	...
	var KTDatatablesServerSide = function () {
		...
		var filterPayment;
		var channalid = '10';
		var userlist = "jsondata/getJobtaskStockTags/2"; // seq3 1= open , 2 = keyin
		// Private functions
			...
			dt = $("#kt_datatable_horizontal_scroll").DataTable({
				...
				columnDefs: [
											...
											if(trimmedID.length === 12){
												$.ajax({
													...
													success: function(response) {
														...
														window.location.href = "<?= base_url('myjobstock') ?>"; // Ensure the URL is correct
													},
										...
										if (trackingPattern.test(trimmedID)) {
											if(trimmedID.length === 12){
												...
												$.ajax({
													...
													success: function(response) {
														console.log(response);
														window.location.href = "<?= base_url('myjobstock') ?>";  // Use PHP to dynamically generate the URL
													},
													error: function(xhr, status, error) {
														console.error('AJAX error:', status, error);
													}
					...
					},
					{
						...
						render: function (data, type, row) {
                            return `
								<a href="<?php echo base_url();?>returnjob/${data.id}/myjobstock" class="btn btn-light-danger btn-sm">
									Return Job
								</a>
							`;
						},
		...
		var hadleCallJob = () => {
			...
			calljobButton.addEventListener('click', function (e) {
				...
				$.ajax({
					url: '<?php echo base_url(); ?>jsondata/getJobtaskUpdateCalljob/3',
					type: 'GET',
...
<script>
	...
	$("#myjobstock").addClass('btn-light-primary');
</script>