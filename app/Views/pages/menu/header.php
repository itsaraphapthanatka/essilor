...
<html lang="en">
	...
	<head><base href="../../../" />
		...
		<link href="<?php echo base_url();?>script/css/custom.css" rel="stylesheet" type="text/css" />
		...
		<script src="<?=base_url();?>script/js/convert_color_hex_to_rgb.js"></script>
		<script src="<?php echo base_url();?>theme/demo20/assets/plugins/custom/tinymce/tinymce.bundle.js"></script>
		<script src="https://cdn.jsdelivr.net/npm/axios/dist/axios.min.js"></script>
		
	</head>
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="header-extended header-fixed">
