...
<div class="toolbar py-3 py-lg-6" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
        ...
        <div class="d-flex align-items-center">
            <a href="<?php echo base_url();?>create_tag" class="btn btn-primary me-3">New Tag</a>
        </div>
        <!--end::Actions-->
    </div>
    <!--end::Container-->
                ...
                <div class="table-responsive">
                    ...
                    <table id="kt_datatable_horizontal_scroll" class="table align-middle table-row-dashed fs-6 gy-5" >
                        ...
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">TAG Category</th>
                            <th class="text-center min-w-200px">TAG DESIGN</th>
                            <th class="text-center min-w-200px">DUE DATE</th>
				...
				columnDefs: [
                    ...
                    },
                    {
                        ...
                        render: function(data,type,row){
                            return  `
                                <span class="badge" style="color: ${row.text_color}; background-color: ${row.background_color};">
                                    ${row.tag_name}
                                </span>
                            `
                        }
                    ...
                    },
					{
						...
						render: function (data, type, row) {
                            return `
								<a href="<?php echo base_url();?>edit_tag/${data.id}" class="btn btn-light btn-active-light-primary btn-sm">
									Edit
								</a>
		...
		var handleDeleteRows = () => {
			...
			deleteButtons.forEach(d => {
				...
				d.addEventListener('click', function (e) {
					...
					const tagname = parent.querySelectorAll('td')[1].innerText;
