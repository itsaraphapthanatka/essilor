    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
        ...
        <div class="page-title d-flex flex-column align-items-start me-3 py-2 py-lg-0 gap-2">
            ...
            <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-gray-600">Tag Edit</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
...
<div id="kt_content_container" class="d-flex flex-column-fluid align-items-start px-10">
    ...
    <div class="content flex-row-fluid" id="kt_content">
        <form id="add_form" action="<?php echo base_url();?>UpdateTags" method="post" enctype="multipart/form-data">
            <div class="card mb-6">
                <!--begin::Card header-->
                ...
                <div class="card-body border-top p-9">
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-12 fv-row">
                                    <input type="hidden" name="tagid" value="<?php echo $tags['id'];?>" />
                                    <input type="text" name="tagname" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Tag Name" value="<?php echo $tags['tag_name'];?>" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                        <div class="col-lg-12 fv-row">
                                <input type="text" name="tag_meaning" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Tag Meaning" value="<?php echo $tags['tag_meaning'];?>"/>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-6" hidden>
                        <label class="col-lg-4 col-form-label required fw-semibold fs-6">Tag Category</label>
                        <div class="col-lg-8">
                            <div class="col-lg-12 fv-row">
                                <select name="tag_category" data-control="select2" data-placeholder="Select a format" data-hide-search="false" class="form-select form-select-solid fw-bold">
                                    <?php foreach($category as $val){?>
                                        <?php if($tags['tag_category'] == $val['id']){?>
                                            <option selected="selected" value="<?php echo $val['id'];?>"><?php echo $val['category_name'];?></option>
                                        <?php }else{ ?>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <div class="col-lg-12 fv-row">
                            <input type="color" class="form-control form-control-color" id="tagColorInput" name="text_color" value="<?php echo $tags['text_color'];?>" title="Choose your color">
                            </div>
                        </div>
                    </div>
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <div class="col-lg-12 fv-row">
                            <input type="color" class="form-control form-control-color" id="bgColorInput" name="bg_color" value="<?php echo $tags['background_color'];?>" title="Choose your color">
                            </div>
                        </div>
                    </div>
                </div>
