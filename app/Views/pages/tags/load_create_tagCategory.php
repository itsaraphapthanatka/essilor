...
<div id="kt_content_container" class="d-flex flex-column-fluid align-items-start px-10">
    ...
    <div class="content flex-row-fluid" id="kt_content">
        <form id="add_form" action="<?php echo base_url();?>CreateTagCategory" method="post" enctype="multipart/form-data">
            <div class="card mb-6">
                <!--begin::Card header-->
                ...
                <div class="card-body border-top p-9">
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-12 fv-row">
                                    <input type="text" name="categoryname" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Category Name" value="" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-12 fv-row">
                                <select name="tag_category_status" data-control="select2" data-placeholder="Select a format" data-hide-search="false" class="form-select form-select-solid fw-bold">
