    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
        ...
        <div class="page-title d-flex flex-column align-items-start me-3 py-2 py-lg-0 gap-2">
            ...
            <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-gray-600">Edit ECP</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
...
<div id="kt_content_container" class="d-flex flex-column-fluid align-items-start px-10">
    ...
    <div class="content flex-row-fluid" id="kt_content">
        <form id="add_form" action="<?php echo base_url();?>UpdateEcp" method="post" enctype="multipart/form-data">
            <!--begin::Card-->
            <div class="card mb-6">
                <!--begin::Card header-->
                ...
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-12 fv-row">
                                    <input type="text" name="ecpname" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="ECP Name" value="<?=$ecp['customer_name'];?>" />
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-12 fv-row">
                                    <select name="payment" data-control="select2" data-placeholder="Select a format" data-hide-search="false" class="form-select form-select-solid fw-bold">
                                        <?php foreach ($payment as $pay): ?>
                                            <option value="<?= $pay->payment_term_cd ?>" <?= $pay->payment_term_cd == $ecp['payment_term_cd'] ? 'selected' : '' ?>><?= $pay->payment_term_cd ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                ...
                <div class="card-body border-top p-9">
                    <div class="row mb-6" hidden>
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                            <div class="col-lg-12 fv-row">
                                <input type="text" name="title" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="SA24_0348" value="<?=$ecp['promo_code'];?>"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-6" hidden>
                        ...
                        <div class="col-lg-8">
                        <div class="col-lg-12 fv-row">
                            <input type="text" name="bu" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Essilor" value="<?=$ecp['bu'];?>"/>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-6" hidden>
                        ...
                        <div class="col-lg-8">
                            <div class="col-lg-12 fv-row">
                                <input type="text" name="promo_type" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="โปรร้าน" value="<?=$ecp['promo_type'];?>"/>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-6" hidden>
                        ...
                        <div class="col-lg-8">
                            <div class="col-lg-12 fv-row">
                                <input type="text" name="promo_name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Selling Right" value="<?=$ecp['promo_name'];?>"/>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-6" hidden>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                    <input class="form-control form-control-solid" name="calendar_event_start_date" placeholder="Pick a start date" id="kt_calendar_datepicker_start_date" value="<?=$ecp['promo_start_date'];?>"/>
                                </div>
                                <!--end::Col-->

                                <!--begin::Col-->
                                <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                    <input class="form-control form-control-solid" name="calendar_event_end_date" placeholder="Pick a end date" id="kt_calendar_datepicker_end_date" value="<?=$ecp['promo_end_date'];?>" />
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Row-->
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <div class="col-lg-12 fv-row">
                                <div class="form-floating">
                                    <textarea class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Leave a comment here" id="Detail" name="detail" style="height: 100px"><?=$ecp['promo_details'];?></textarea>
                        ...
                        <div class="col-lg-8">
                            <div class="col-lg-12 fv-row">
                                <select name="logis_note" data-control="select2" data-placeholder="Select a format" data-hide-search="false" class="form-select form-select-solid fw-bold">
                                    <?php foreach ($logis as $log): ?>
                                        <option value="<?= $log->logis_note ?>" <?= $log->logis_note == $ecp['logis_note'] ? 'selected' : '' ?>><?= $log->logis_note ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                ...
                <div class="card-body border-top p-9">
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-12 fv-row">
                                    <select name="c_customer_parent_group" class="form-select form-select-solid fw-bold">
                                        <?php foreach($c_customer_parent_group as $group): ?>
                                            <option value="<?= $group->c_customer_parent_group ?>" <?= $group->c_customer_parent_group == $ecp['c_customer_parent_group'] ? 'selected' : '' ?>><?= $group->c_customer_parent_group ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-8">
                            <div class="col-lg-12 fv-row">
                                <select name="essilor_experts" data-control="select2" data-placeholder="Select a format" data-hide-search="false" class="form-select form-select-solid fw-bold">
                                    <?php foreach($c_experts as $expert): ?>
                                        <option value="<?= $expert->c_experts ?>" <?= $expert->c_experts == $ecp['c_experts'] ? 'selected' : '' ?>><?= $expert->c_experts ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-8">
                            <div class="col-lg-12 fv-row">
                                <select name="essilor_partner" data-control="select2" data-placeholder="Select a format" data-hide-search="false" class="form-select form-select-solid fw-bold">
                                    <?php foreach($c_partner as $partner): ?>
                                        <option value="<?= $partner->c_partner ?>" <?= $partner->c_partner == $ecp['c_partner'] ? 'selected' : '' ?>><?= $partner->c_partner ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-8">
                            <div class="col-lg-12 fv-row">
                                <select name="nikon_lenwear_partner" data-control="select2" data-placeholder="Select a format" data-hide-search="false" class="form-select form-select-solid fw-bold">
                                    <?php foreach($nikon_lenswear_partner as $partner): ?>
                                        <option value="<?= $partner->nikon_lenswear_partner ?>" <?= $partner->nikon_lenswear_partner == $ecp['nikon_lenswear_partner'] ? 'selected' : '' ?>><?= $partner->nikon_lenswear_partner ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-8">
                            <div class="col-lg-12 fv-row">
                                <select name="upgrade_coating" data-control="select2" data-placeholder="Select a format" data-hide-search="true" class="form-select form-select-solid fw-bold">
                                    <?php if($ecp['upgrade_coating'] == 'Yes'){ ?><option value="Yes" selected>Yes</option><?php } else { ?><option value="Yes">Yes</option><?php }?>
                                    <?php if($ecp['upgrade_coating'] == 'No'){ ?><option value="No" selected>No</option><?php } else { ?><option value="No">No</option><?php }?>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-8">
                            <div class="col-lg-12 fv-row">
                                <select name="upgrade_azio" data-control="select2" data-placeholder="Select a format" data-hide-search="true" class="form-select form-select-solid fw-bold">
                                    <?php if($ecp['upgrade_azio'] == 'Yes'){ ?><option value="Yes" selected>Yes</option><?php } else { ?><option value="Yes">Yes</option><?php }?>
                                    <?php if($ecp['upgrade_azio'] == 'No'){ ?><option value="No" selected>No</option><?php } else { ?><option value="No">No</option><?php }?>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-8">
                            <div class="col-lg-12 fv-row">
                                <select name="upgrade_f360" data-control="select2" data-placeholder="Select a format" data-hide-search="true" class="form-select form-select-solid fw-bold">
                                    <?php if($ecp['upgrade_f360'] == 'Yes'){ ?><option value="Yes" selected>Yes</option><?php } else { ?><option value="Yes">Yes</option><?php }?>
                                    <?php if($ecp['upgrade_f360'] == 'No'){ ?><option value="No" selected>No</option><?php } else { ?><option value="No">No</option><?php }?>
                                </select>
                            </div>
                        </div>
                    </div>
