                                                    ...
                                                    <div class="fv-row row mb-10">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" readonly class="form-control" id="tender_no" name="tender_no" aria-label="" value="<?=$tender['bd_tenid'];?>"/>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="fv-row row mb-10">
                                                        ...
                                                        <div class="col-md-9">
                                                            <!--begin::Input-->
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" id="bidbond" name="bidbond" aria-label="" value="<?=$tender['bondamount'];?>"/>
                                                                <!-- <span class="input-group-text">Amount</span> -->
                                                            </div>
                                                            <!--end::Input-->
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="fv-row row mb-10">
                                                        ...
                                                        <div class="col-md-9">
                                                            <!--begin::Input-->
                                                            <div class="input-group">
                                                                <input type="text" name="tender_name" class="form-control mb-2" placeholder="Tender Name" value="<?=$tender['bd_pname'];?>" />
                                                                <!-- <span class="input-group-text">Amount</span> -->
                                                            </div>
                                                            <!--end::Input-->
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="fv-row row mb-10">
                                                        ...
                                                        <div class="col-md-9">
                                                            <!--begin::Input-->
                                                            <div class="input-group">
                                                                <input type="text" id="kt_bidbond_start" name="kt_bidbond_start" class="form-control mb-2" placeholder="Bid Bond Date" value="<?php if($tender['bonddate'] == '0000-00-00' || $tender['bonddate'] == ''){}else{echo $tender['bonddate'];};?>" />
                                                                <!-- <span class="input-group-text">Amount</span> -->
                                                            </div>
                                                            <!--end::Input-->
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="fv-row row mb-10">
                                                        ...
                                                        <div class="col-md-9">
                                                            <!--begin::Input-->
                                                            <div class="input-group">
                                                                <input type="text" id="kt_date_start" name="start_date" class="form-control mb-2" placeholder="Start Date" value="<?php if($tender['bd_date'] == '0000-00-00' || $tender['bd_date'] == ''){}else{echo $tender['bd_date'];};?>" />
                                                                <!-- <span class="input-group-text">Amount</span> -->
                                                            </div>
                                                            <!--end::Input-->
                                                        </div>
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            <div class="input-group">
                                                                <select class="form-select" data-kt-repeater="select2" data-placeholder="Open this select menu" data-allow-clear="true" name="bu" id="bu">
                                                                    <?php if($tender['bd_cus'] == ''){ ?>
                                                                        <option></option>
                                                                    <?php }?>
                                                                    <?php foreach ($customer as $key => $value) {?>
                                                                        <?php if($tender['bd_cus'] == $value['debtor_code']){ ?>
                                                                            <option  value="<?=$value['debtor_code'];?>" selected="selected"><?=$value['debtor_name'];?></option>
                                                                        <?php }else{?>
                                                                            <option value="<?=$value['debtor_code'];?>"><?=$value['debtor_name'];?></option>
                                                                        <?php } ?>
                                                                    <?php } ?>
                                                                </select>
                                                                <!-- <span class="input-group-text">Amount</span> -->
                                                ...
                                                <div class="col-md-6">
                                                    <div class="fv-row row mb-10">
                                                        ...
                                                        <div class="col-md-9">
                                                            <!--begin::Input-->
                                                            <div class="input-group">
                                                                <input type="text" readonly class="form-control form-control-solid text-end" id="contractAmount" name="contractAmount" aria-label="" value="<?=$tender['bondamount'];?>"/>
                                                                <!-- <span class="input-group-text">Amount</span> -->
                                                            </div>
                                                            <!--end::Input-->
                                                        </div>
														...
														<div id="systemtype">
															<div class="form-group">
                                                                <div data-repeater-list="systemtype" class="d-flex flex-column gap-3">
                                                                    <?php foreach ($listTender as $key => $list) {?>
																	<div data-repeater-item="" class="form-group d-flex flex-wrap align-items-center gap-5">
																		<div class="w-100 w-md-300px">
																			<select class="form-select" data-kt-repeater="select2" name="system_type_name" data-placeholder="Please Select System Type" data-kt-add-project="project_option">
																				<option value="<?=$list['bdd_jobno']?>"><?=$list['bdd_jobname']?></option>
																				
																			</select>
																		</div>
																		<div class="w-100 w-md-200px">
																			<input type="text" class="form-control amount" id="systemtypevalue" name="systemtypevalue" aria-label="" value="<?=$list['bdd_amount'];?>"/>
																		</div>
