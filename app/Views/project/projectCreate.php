		...
		<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
			...
			<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
				...
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					<!--begin::Title-->
					<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">New Project</h1>
					<!--end::Title-->
				</div>
				<!--end::Page title-->
			</div>
									...
									<div class="tab-content" id="myTabContent">
										<div class="tab-pane fade show active" id="kt_tab_pane_1" role="tabpanel">
											<div class="d-flex flex-wrap gap-5">
                                                ...
                                                <div class="mb-10 fv-row w-100 flex-md-root">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="text" id="project_code" name="project_code" class="form-control mb-2" placeholder="Project Code" value="" />
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                                <!--begin::Input group-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" name="project_name" class="form-control mb-2" placeholder="Project Name" value="" />
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                            ...
                                            <div class="d-flex flex-wrap gap-5">
                                                ...
                                                <div class="mb-10 fv-row w-100 flex-md-root">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" id="wtper" name="wtper" aria-label=""/>
                                                ...
                                                <div class="mb-10 fv-row w-100 flex-md-root">
                                                    ...
                                                    <!--begin::Input-->
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" id="vatper" name="vatper" aria-label=""/>
                                                        <span class="input-group-text">%</span>
                                                    </div>
                                                    <!--end::Input-->
                                                </div>
                                                ...
                                                <div class="mb-10 fv-row w-100 flex-md-root">
                                                    ...
                                                    <!--begin::Input-->
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" id="insuranceContract" name="insuranceContract" aria-label=""/>
                                            ...
                                            <div class="d-flex flex-wrap gap-5">
                                                ...
                                                <div class="mb-10 fv-row w-100 flex-md-root">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input id="kt_date_start" name="start_date" placeholder="Start Project" class="form-control mb-2" value="" />
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                                <!--begin::Input group-->
                                                <div class="mb-10 fv-row w-100 flex-md-root">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input id="kt_date_end" name="end_date" placeholder="End Project" class="form-control mb-2" value="" />
                                                    <!--end::Input-->
                                                </div>
                                                <div class="mb-10 fv-row w-100 flex-md-root">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <textarea type="text" class="form-control form-control-lg mb-3 mb-lg-0" id="desc" name="description"></textarea>
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
										...
										<div class="tab-pane fade" id="kt_tab_pane_2" role="tabpanel">
											<div class="fv-row row mb-10">
												...
												<div class="col-md-9">
													...
													<div class="form-check form-switch form-check-custom form-check-solid me-10">
														<input class="form-check-input h-30px w-50px" name="controlboq" type="checkbox" value="" id="controlboq" />
											...
											<div class="fv-row row mb-10">
												...
												<div class="col-md-9">
													<!--begin::Input-->
													<select name="tenderno" aria-label="Select a Tender Bid" data-control="select2" data-hide-search="false" data-allow-clear="true" data-placeholder="Select a Tender Bid..." class="form-select mb-2">
														<option></option>
