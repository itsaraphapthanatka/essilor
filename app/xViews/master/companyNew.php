		...
		<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
			...
			<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
				...
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					<!--begin::Title-->
					<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">New Company</h1>
					<!--end::Title-->
				</div>
				<!--end::Page title-->
			</div>
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="d-flex flex-wrap gap-5">
                                                ...
                                                <div class="mb-10 fv-row w-100 flex-md-root">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="text" readonly="readonly" name="compcode" class="form-control form-control-solid mb-2" placeholder="รหัสบริษัท" value="" />
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                            </div>
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" name="company_nameth" class="form-control mb-2" placeholder="ชื่อบริษัท" value="" />
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" name="company_name" class="form-control mb-2" placeholder="ชื่อบริษัท (ENG)" value="" />
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                             <!--begin::Input group-->
                                             <div class="mb-10 fv-row">
                                                ...
                                                <textarea class="form-control form-control-lg mb-3 mb-lg-0" rows="5" id="company_addr" name="company_addr"></textarea>
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                            <div class="d-flex flex-wrap gap-5">
                                                ...
                                                <div class="mb-10 fv-row w-100 flex-md-root">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="text" name="taxno" class="form-control mb-2" placeholder="เลขประจำตัวผู้เสียภาษี" value="" />
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                                <!--begin::Input group-->
                                                <div class="mb-10 fv-row w-100 flex-md-root">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="text" name="tel" placeholder="เบอร์โทร" class="form-control mb-2" value="" />
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                                <!--begin::Input group-->
                                                <div class="mb-10 fv-row w-100 flex-md-root">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="text" name="fax" class="form-control mb-2" placeholder="แฟกซ์" value="" />
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                            </div>
                                            ...
                                            <div class="d-flex flex-wrap gap-5">
                                                ...
                                                <div class="mb-10 fv-row w-100 flex-md-root">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="email" id="email" name="email" placeholder="อีเมล์" class="form-control mb-2" value="" />
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                                <!--begin::Input group-->
                                                <div class="mb-10 fv-row w-100 flex-md-root">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="text" name="contact" placeholder="ผู้ติดต่อ" class="form-control mb-2" value="" />
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                                 <!--begin::Input group-->
