           ...
           <div id="kt_app_content_container" class="app-container container-fluid">
               ...
               <div class="card">
                   ...
                   <div class="card-header">
                       <h2 class="card-title fw-bold">ตั้งค่าผู้ดูแลห้อง</h2>
                       <div class="card-toolbar">
                           ...
                           <!--end::Svg Icon-->เพิ่มผู้ดูแลห้อง</button>
                       </div>
                   </div>
                   <!--end::Card header-->
                   <!--begin::Card body-->
                       ...
                       <div class="modal-content">
                           ...
                           <form class="form" action="<?php echo base_url(); ?>setupCalendar" method="post" enctype="multipart/form-data" id="kt_modal_add_event_form">
                               ...
                               <div class="modal-header">
                                   <!--begin::Modal title-->
                                   <h2 class="fw-bold" data-kt-calendar="title">เพิ่มผู้ดูแลห้อง</h2>
                                   <!--end::Modal title-->
                                   <!--begin::Close-->
                                               ...
                                               <div data-repeater-item>
                                                  <div class="form-group row position-relative mt-6">
                                                      <div class="col-md-3">
                                                          ...
                                                          <select class="form-select"  data-control="select2" data-placeholder="เลือกห้อง" name="room" id="room">
                                                            <?php foreach ($room as $rval) {?>  
                                                             <option value="<?=$rval['id']?>"><?=$rval['room_name'];?></option>
                                                            <?php }?>
                                                         </select>
                                                      </div>
                                                      <div class="col-md-3">
                                                          <label class="form-label">ผู้ดูแล:</label>
                                                          <select class="form-select" data-control="select2" data-placeholder="เลิอกผู้ดูแล" name="user" id="user">
                                                              <?php foreach ($user as $uval) {?>  
                                                               <option value="<?=$uval['user_name']?>"> <?=$uval['user_name'];?></option>
                                                              <?php }?>
                                                           </select>
                                                      </div>
                                                      <div class="col-md-4">
                                    ...
                                    <div id="limittime" hidden>
                                        ...
                                        <div class="border border-warning border-dashed rounded min-w-100px w-100 py-2 px-4 me-6 mb-3">
                                            <div class="row mb-6">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-4">
                                                   <input type="text" class="form-control text-center" placeholder="3" aria-label="จำกัดเวลาทำการ" name="limitdate" aria-describedby="basic-addon2" value="0"/>
                                                <!--end::Col-->
                                                </div>
...
var KTAppCalendar = function () {
    ...
    const handleViewEvent = () => {
        ...
        $(".loadedit").load("/load_roomadmin?startdate="+data.startDate);
// 
