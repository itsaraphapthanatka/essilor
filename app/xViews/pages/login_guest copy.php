...
<html lang="en">
	...
	<body id="kt_body" class="app-blank">
				...
				<div class="d-flex flex-column flex-lg-row-fluid py-10">
					...
					<div class="d-flex flex-center flex-column flex-column-fluid">
						...
						<div class="w-lg-650px w-xl-700px p-10 p-lg-15 mx-auto">
							<!--begin::Form-->
							<form class="my-auto pb-5" novalidate="novalidate" id="kt_sign_in_form" action="<?php echo base_url();?>loginLevel" method="post" enctype="multipart/form-data">
								<!--begin::Step 1-->
												...
												<div class="col-lg-12 fv-row fv-plugins-icon-container">
													...
													<div class="d-flex align-items-center mt-3">
														...
														<label class="form-check form-check-custom form-check-inline form-check-solid me-5">
															<input class="form-check-input" name="leveltype1" type="checkbox" value="1">
														...
														<label class="form-check form-check-custom form-check-inline form-check-solid">
															<input class="form-check-input" name="leveltype2" type="checkbox" value="2">
															<span class="fw-semibold ps-2 fs-6">
																Keyin
															</span>
														</label>
														...
														<!--begin::Option-->
														<label class="form-check form-check-custom form-check-inline form-check-solid">
															<input class="form-check-input" name="leveltype3" type="checkbox" value="3">
															<span class="fw-semibold ps-2 fs-6">
																Support
															</span>
														</label>
														...
														<!--begin::Option-->
														<label class="form-check form-check-custom form-check-inline form-check-solid">
															<input class="form-check-input" name="leveltype4" type="checkbox" value="4">
															<span class="fw-semibold ps-2 fs-6">
																Feedback
															</span>
														</label>
		...
		<!-- <script src="<?php echo base_url();?>script/js/login_guest.js"></script> -->
