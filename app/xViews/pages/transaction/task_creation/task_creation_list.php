    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
        ...
        <div class="page-title d-flex flex-column align-items-start me-3 py-2 py-lg-0 gap-2">
            ...
            <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-gray-600">List Task View</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
        ...
        <div class="d-flex align-items-center">
            <a href="<?=base_url()?>createtask" class="btn btn-primary me-3">New Task</a>
        </div>
        <!--end::Actions-->
    </div>
    <!--end::Container-->
...
<script>
	...
	var KTDatatablesServerSide = function () {
		...
		var filterPayment;
		var channalid = '10';
		var userlist = "jsondata/getJobtask";
		// Private functions
...

					{
						...
						render: function (data, type, row) {
							if(data.statusname === 'Open'){
								...
								return `
									<span class="badge badge-light-warning fs-6">${data.statusname}</span>
								`;
							}
						},
					},
...
<script>
	...
	//  $("#creattion_task_list_view").addClass('active show');
