                            ...
                            <div class="align-self-end overflow-auto" id="kt_brand_tabs">
                                ...
                                <div class="header-tabs overflow-auto mx-4 ms-lg-10 mb-5 mb-lg-0" id="kt_header_tabs" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_header_navs_wrapper', lg: '#kt_brand_tabs'}">
                                    ...
                                    <ul class="nav flex-nowrap text-nowrap">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" data-bs-toggle="tab" href="#kt_header_navs_tab_1">Task Creation</a>
                                        </li>
                                        <?php } ?>
                                        <?php if(session()->get('type') == 'keyin'){ ?>
                                        <li class="nav-item">
                                            <a class="nav-link active" data-bs-toggle="tab" href="#kt_header_navs_tab_2">Keyin</a>
                                        </li>
                                        <?php } ?>
                                        <?php if(session()->get('type') == 'support'){ ?>
                                        <li class="nav-item">
                                            <a class="nav-link active" data-bs-toggle="tab" href="#kt_header_navs_tab_3">Support</a>
                                        </li>
                                        <?php } ?>
                                        <?php if(session()->get('type') == 'feedback'){ ?>
                                        <li class="nav-item">
                                            <a class="nav-link active" data-bs-toggle="tab" href="#kt_header_navs_tab_4">Feedback</a>
                                        </li>
                                        <?php } ?>
                                    </ul>
                                    <!--begin::Header tabs-->
