            ...
            <div class="container">
                <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                    ...
                    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                        ...
                        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                            ...
                            <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Setup Permission Project</h1>
                            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                ...
                                <!--begin::Item-->
                                <li class="breadcrumb-item text-muted">
                                    <a href="/setupPermission/<?=$seq1;?>/<?=$seq2;?>/<?=$seq3;?>" class="text-muted text-hover-primary">Permisstion</a>
                                </li>
                                <!--end::Item-->
                            </ul>
                            <!--end::Title-->
                ...
                <div class="card mb-6 mb-xl-9">
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <!--begin::Pic-->
                            <div class="flex-shrink-0 me-7 mb-4">
                                ...
                                <div class="d-flex align-items-center justify-content-between flex-wrap">
                                    ...
                                    <div class="mr-3">
                                        <div class="d-flex align-items-center mr-3">
                                            <!--begin::Name-->
                                            <a href="#" class="text-gray-800 text-hover-primary fs-2 fw-bold me-3"><?php echo $getmemb[0]['m_name'];?></a>
                                            <!--end::Name-->
                                            <span class="ms-2 badge badge-light-success fw-bold text-uppercase"><?php echo strtoupper($getmemb[0]['m_type']);?></span>
                                        </div>
                                        <!--begin::Contacts-->
                                        <div class="d-flex flex-wrap my-2">
                                            <a href="#" class="text-muted text-hover-primary font-weight-bold  me-6 mb-3">
                                            <span class="svg-icon svg-icon-md svg-icon-gray-500 mr-3">
                ...
                <div class="card card-custom">
                    <div class="card-body">
                        ...
                        <input type="hidden" id="userid" value="<?=$seq4;?>">
        ...
        headerCallback: function(thead, data, start, end, display) {
            ...
            if (i === counter) {
                ...
                <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                    <input class="form-check-input group-checkable" type="checkbox" checked data-kt-check="true"/>
                </div>`;
                // document.getElementById("show").value = "chkall";
            }else{
                thead.getElementsByTagName('th')[0].innerHTML = `
                <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                    <input class="form-check-input group-checkable" type="checkbox" data-kt-check="false"/>
                </div>`;
                ...
                render: function(data, type, full, meta) {
                    ...
                    if (full[2]=="Y") {
                        return `
                            ...
                            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                <input class="form-check-input checkable" name="myCheckbox" checked type="checkbox" data-kt-check="true" value="${full[3]}"/>
                            </div>
                            `;
                    }else{
                        return `
                            ...
                            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                <input class="form-check-input checkable" name="myCheckbox" type="checkbox" data-kt-check="false" value="${full[3]}"/>
                            </div>
                            `;
