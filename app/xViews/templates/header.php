				...
				<div id="kt_app_header" class="app-header">
					...
					<div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
						...
						<div class="app-header-logo d-flex align-items-center ps-lg-2 me-lg-10">
							...
							<!--begin::Logo image-->
							<a href="/dashboard">
								<img alt="Logo" src="<?php echo base_url();?>theme/dist/assets/media/logos/logp_top.jpg" class="h-30px" />
							</a>
							<!--end::Logo image-->
						</div>
						<!--end::Header logo-->
										...
										<div class="menu-item px-3">
											<div class="menu-content d-flex align-items-center px-3">
												...
												<div class="d-flex flex-column">
													<div class="fw-bold d-flex align-items-start fs-5"><?= session()->get('user_name');?></div>
													<?php if(session()->get('user_role')==1){?>
														<span class="badge badge-light-primary fw-bold fs-7">Super Administrator</span>
													<?php }else if(session()->get('user_role')==2){?>
														<span class="badge badge-light-success fw-bold fs-7">Admin Controller</span>
													<?php }else{?>
														<span class="badge badge-light-info fw-bold fs-7">Admin Branch</span>
													<?php } ?>
