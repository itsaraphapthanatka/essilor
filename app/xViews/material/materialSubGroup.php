		...
		<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
			...
			<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
				...
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					<!--begin::Title-->
					<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Setup Material Subgroup</h1>
					<!--end::Title-->
					<!--begin::Breadcrumb-->
					<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
						...
						<!--end::Item-->
						<!--begin::Item-->
						<li class="breadcrumb-item text-muted">Setup Material Subgroup</li>
						<!--end::Item-->
					</ul>
					<!--end::Breadcrumb-->
				</div>
					...
					<div class="card-header pt-8">
						<div class="card-title">
							...
							<div class="d-flex align-items-center position-relative my-1">
								...
								<input type="text" data-kt-filemanager-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Material Subgroup" />
							</div>
							<!--end::Search-->
						</div>
						<!--begin::Card toolbar-->
					...
					<div class="card-body">
						...
						<div class="d-flex flex-stack">
							...
							<div class="badge badge-lg badge-light-success">
                                ...
                                <?=$type['mattype_code']?><?=$group['matgroup_code'];?>
							</div>
							</div>
							<!--end::Folder path-->
						</div>
...
<script>
	...
	var KTDatatablesServerSide = function () {
		...
		var userlist = "jsondata/getmaterialsubGroup/"+mat_type+"/"+mat_group;
		var type_status = {
		...
		var initDatatable = function () {
			dt = $("#kt_datatable_").DataTable({
				...
				columns: [
					{ data: 'matsubgroup_code' },
					{ data: 'matsubgroup_name' },
					{ data: 'matsubgroup_status' },
					{ data: null },
				],
				columnDefs: [
                    {
					...
					},
                    {
						...
						render: function(data, type, row) {
							return `<a href="/setupMaterialProduct/<?=$seq1;?>/<?=$seq2;?>/<?=$seq3;?>/${row.mattype_code}/${row.matgroup_code}/${row.matsubgroup_code}">${row.matsubgroup_name}</a>`;
						}
					},
                    {
                        targets: 2, //สถานะ
