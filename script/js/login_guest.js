				  ...
				  $.ajax({
					...
					data: frm.serialize(),
					  success: function (data) {
						  console.log(data);
						  var json = data;
						  var leveltype = json.level.leveltype;
						  let count = json.level.leveltype.length;
						// console.log(json.level.leveltype);
						
						console.log("Count : "+json.level.leveltype.length);
						
						switch (count) {
							case 1 :
							// console.log(leveltype[0]);
								window.location.href = "/level2/"+leveltype[0]+"/0/0/0";
								break; 
							case 2 :
							// console.log(leveltype[0]+"/"+leveltype[1]);
								window.location.href = "/level2/"+leveltype[0]+"/"+leveltype[1]+"/0/0";
								break; 
							case 3 :
								// console.log(leveltype[0]+"/"+leveltype[1]+"/"+leveltype[2]);
								window.location.href = "/level2/"+leveltype[0]+"/"+leveltype[1]+"/"+leveltype[2]+"/0";
								break; 
							case 4 :
								window.location.href = "/level2/"+leveltype[0]+"/"+leveltype[1]+"/"+leveltype[2]+"/"+leveltype[3];
								break; 
							default:
								window.location.href = "/home/level/all";
								break;
						 }
						...
						// 	window.location.href = "/home/level/all";
						// }else{
						// 	// for (let key of json.taskCreator) {
						// 	// 	console.log(key);
						// 		// switch (key) {
						// 		// 	case 1 :
						// 		// 		window.location.href = "/home/level/1";
						// 		// 		break; 
						// 		// 	case 2 :
						// 		// 		window.location.href = "/home/level/2";
						// 		// 		break; 
						// 		// 	case 3 :
						// 		// 		window.location.href = "/home/level/3";
						// 		// 		break; 
						// 		// 	case 4 :
						// 		// 		window.location.href = "/home/level/4";
						// 		// 		break; 
						// 		// 	default:
						// 		// 		window.location.href = "/home/level/all";
						// 		//  }
